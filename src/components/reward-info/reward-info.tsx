...
const RewardsInfo: React.FC = () => {
  return (
    <section className="relative md:py-32 py-24">
      <div className="absolute inset-0 bg-secondary-50 blur-2xl z-[-1]"></div>
      <div className="container xl:px-56 lg:px-44 md:px-24 sm:px-10 px-4 z-10">
        ...
        <p className="text-base leading-6 text-secondary font-light md:mb-6 mb-8 text-center">
        ...
        <p className="text-base leading-6 text-secondary font-light md:md:mb-6 mb-8 text-center">
        ...
        <p className="text-base leading-6 text-secondary font-light text-center">
